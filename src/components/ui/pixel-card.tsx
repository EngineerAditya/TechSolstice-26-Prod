...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden grid place-items-center border border-white/20 rounded-3xl isolate transition-all duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none bg-black/40 backdrop-blur-xl shadow-2xl ${className}`}
